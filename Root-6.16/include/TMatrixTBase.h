...
template<class Element> Bool_t VerifyMatrixValue   (const TMatrixTBase<Element> &_m,Element val,
                                                    Int_t verbose,Element maxDevAllow);
template<class Element> Bool_t VerifyMatrixValue   (const TMatrixTBase<Element> &_m,Element val,Int_t verbose)
                                                                           { return VerifyMatrixValue(_m,val,verbose,Element(0.)); }
template<class Element> Bool_t VerifyMatrixValue   (const TMatrixTBase<Element> &_m,Element val)
                                                                           { return VerifyMatrixValue(_m,val,1,Element(0.)); }
template<class Element> Bool_t VerifyMatrixIdentity(const TMatrixTBase<Element> &_m1,const TMatrixTBase<Element> &_m2,
                                                    Int_t verbose,Element maxDevAllow);
template<class Element> Bool_t VerifyMatrixIdentity(const TMatrixTBase<Element> &_m1,const TMatrixTBase<Element> &_m2,Int_t verbose)
                                                                           { return VerifyMatrixIdentity(_m1,_m2,verbose,Element(0.)); }
template<class Element> Bool_t VerifyMatrixIdentity(const TMatrixTBase<Element> &_m1,const TMatrixTBase<Element> &_m2)
                                                                           { return VerifyMatrixIdentity(_m1,_m2,1,Element(0.)); }
