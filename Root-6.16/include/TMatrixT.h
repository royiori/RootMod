...
public:
   ...
   inline  TMatrixTBase<Element> &ResizeTo(const TMatrixT<Element> &_m) {
                                            return ResizeTo(_m.GetRowLwb(),_m.GetRowUpb(),_m.GetColLwb(),_m.GetColUpb());
                                 }
   ...
   template <class Element2> TMatrixT<Element> &operator= (const TMatrixT<Element2> &source)
   {
     ...
     const Element2 * const _ps = source.GetMatrixArray();
