...
public:
   ...
   virtual inline void ReadStdString(std::string &_s) { ReadStdString(&_s); }
   ...
   virtual inline void WriteStdString(std::string &_s) { WriteStdString(&_s); }
...
inline TBuffer &operator>>(TBuffer &buf, Short_t &_s)  { buf.ReadShort(_s);  return buf; }
inline TBuffer &operator>>(TBuffer &buf, UShort_t &_s) { buf.ReadUShort(_s); return buf; }
...
inline TBuffer &operator>>(TBuffer &buf, TString &_s)  { buf.ReadTString(_s);return buf; }
...
inline TBuffer &operator<<(TBuffer &buf, Short_t _s)  { buf.WriteShort(_s);  return buf; }
inline TBuffer &operator<<(TBuffer &buf, UShort_t _s) { buf.WriteUShort(_s); return buf; }
...
inline TBuffer &operator<<(TBuffer &buf, const TString &_s) { buf.WriteTString(_s);return buf; }
