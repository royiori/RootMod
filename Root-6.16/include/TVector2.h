...
inline TVector2& TVector2::operator *= (Double_t _s) { fX *=_s; fY *=_s; return *this; }
inline TVector2& TVector2::operator /= (Double_t _s) { fX /=_s; fY /=_s; return *this; }
...
inline TVector2  operator * (const TVector2& v, Double_t _s) {
   return TVector2 (v.fX*_s,v.fY*_s);
}

inline TVector2    operator * (Double_t _s, const TVector2& v) {
   return TVector2 (v.fX*_s,v.fY*_s);
}
